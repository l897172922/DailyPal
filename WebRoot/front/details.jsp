...
<body
	...
	<div id="content" class="blog-wrapper">
		<div id="heads">
			<img src="images/daily.gif" class="heads-img" /> <input type="button"
				name="back" id="back" value="返回主页"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<input type="hidden" id="op" name="op" value="comments">
						<!-- 所评论的动态的id -->
			...
			<div id="primary" class="">
				...
				<div class="table-responsive">
					...
					<table>
						...
						<tbody>
							...
							<c:forEach items="${mlist }" var="message">
								...
								<tr>
									<td>${message.fromUsers.nickName }</td>
					...
					<script>
						$(function () {
							 ...
							 $("#sendmessage").click(function(){//一个点击事件 

							var strmassagecontent = $("#bod").val();
							if(strmassagecontent==null&&strmassagecontent.replace(/\s/g,"")==""){
								alert("不能为空");
							}else{
								location.href = "DetailsServlet?op=sendmessage&massagecontent="
									+ strmassagecontent+"&userid="+${user.u_id};
							}
					...
					<div class="div-l">
						<div class="back">
							<textarea name="massagecontent" id="bod" placeholder="请输入留言内容"></textarea>
						</div>
						<p>${nullmsg }</p>
						<a class="btn btn--primary liuyan lick" id="sendmessage"
							style="color:white">发送留言</a>
					</div>
					...
					<c:forEach items="${blist }" var="blog">
						<div class="apart">
							...
							<div class="d-ver">
								<!-- 动态图片 -->
								<div class="d-img">
									<img src="../headpic/${user.headPic }" width="100" />
								</div>
								<div class="entry-header">
									<!-- 内容 -->
									<p>${blog.text }
										<a href="DetailsServlet?op=querycomments&blogid=${blog.b_id}">详情</a> 
									</p>
								</div>
							</div>
							...
							<div>
								...
								<div class="d-nice">
									<div class="CTAs">
										<a href="DetailsServlet?op=like&blogid=${blog.b_id}" class="btn d-h" style="color:white;"><span>${blog.likeCounts }</span><i class="fa fa-thumbs-up"></i>喜欢</a> 
										<%-- <a href="#" class="btn d-h"><span>${blog.commentCounts }</span><i class="fa fa-heart"></i>评论 </a> --%>
										<a class="btn d-h" data-toggle="modal" data-target="#myModal" style="color:white;" onclick="Values(${blog.b_id})"><span>${blog.commentCounts }</span><i class="fa fa-heart"></i>评论 </a>
									</div>
								</div>
							</div>
							<hr />
				...
				<!-- 个人信息 -->
					...
					<div class="profile-wrapper social-menu-wrap">
						...
						<a class="btn btn--primary add" href="#0">加好友</a>
						 <a class="btn btn--primary add" data-toggle="modal" data-target="#myModal2" style="color:white;">举报</a>
						<div id="info">
