...
%>
<%
	//System.out.println(request.getAttribute("mlist"));
		...
		<div class="modal fade" id="myModal2" tabindex="-1" role="dialog"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<p class="m-n">举报内容</p>
						<input type="text" name="" id="" value="" class="m-inp" /> <label
							name=""></label>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn m-sub" data-dismiss="modal">关闭
						</button>
						<button type="button" class="btn m-sub">提交</button>
					</div>
				</div>
				<!-- /.modal-content -->
			</div>
										...
										<li class="gitment-comment">
											<div class="gitment-comment-main">
												...
												<div class="gitment-comment-body gitment-markdown">
													<p>${comment.content }${comment.commentsId}</p><a href="DetailsServlet?op=delcomment&commentid=${comment.commentsId}" class="btn d-h" style="color:white;background-color: black">删除
								</a>
												</div>
...
<a class="btn btn--primary add" href="MyCenterServlet?op=query">修改资料</a> 
				...
				<%-- <p><%=pic.getPath() %></p> --%>
				<%} %> 
					</section> <a class="btn btn--primary add" href="picture.jsp">管理照片</a> </aside>
				<!-- #secondary -->
