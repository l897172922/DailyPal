													...
													<tbody>
														<c:forEach items="${picList }" var="picture" >
															...
															<tr>
																...
																<td>${picture.path }<a href="seepicture.jsp?path=${picture.path }" >详情</a></td>
																<td>${picture.time }</td>
																<td>
																	<a onclick="return confirm('请确认是否删除（一旦删除不可恢复）')" href="ManagerServlet?op=delpic&pictureid=${picture.pictureId }" class="btn btn-xs btn-secondary">违规删除</a>
																</td>
															</tr>
															...
															<td colspan="5" align="center">
																<!-- 分页 -->
																 <ul class="pagination pagination-lg">
																	...
																	<li><a href="ManagerServlet?op=querypic&currPagePic=${picPage.privPage}&pageSizePic=${picPage.pageSize}">&laquo;</a></li>
																	
																     <c:forEach begin="1" end="${picPage.allPage}" step="1" var="i">
																    	<c:if test="${picPage.currPage==i}">
																    			<li class="active"><a href="ManagerServlet?op=querypic&currPagePic=${i}&pageSizePic=${picPage.pageSize}">${i}</a></li>
																    	</c:if>
																    	
																    	<c:if test="${picPage.currPage!=i}">
																    			<li><a href="ManagerServlet?op=querypic&currPagePic=${i}&pageSizePic=${picPage.pageSize}">${i}</a></li>
																    	</c:if>
																   	
																	</c:forEach>
																	
																    <li><a href="ManagerServlet?op=querypic&currPagePic=${picPage.nextPage}&pageSizePic=${picPage.pageSize}">&raquo;</a></li>
